"""
Django settings for freightkare_python project.
...
SECRET_KEY = 'django-insecure-u=&vvoqs*a53&&+x*ff-4=flpc4(e4#uchun3se(jj75s2%nzl'
...
ROOT_URLCONF = 'freightkare_python.urls'
...
WSGI_APPLICATION = 'freightkare_python.wsgi.application'
