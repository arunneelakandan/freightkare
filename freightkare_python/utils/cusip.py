# import sys 
# from config.global_variables import global_variables

# from controller import otto_dynamic_translator as t
# text = 'Verfall: 21. Dezember 2021'
# factentry_translated_text = t.factentry_translator(text)
# print(factentry_translated_text)
...
def get_isin_from_cusip(cusip_str, country_code):
    ...
    def get_numerical_code(c): return str(ord(c) - 55)
    def encode_letters(c): return c if c.isdigit() else get_numerical_code(c)
    ...
    def sum_digits(i): return sum(divmod(i, 10))
