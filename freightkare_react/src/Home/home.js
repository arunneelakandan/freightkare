...
function Home() {
    ...
    $(document).ready(function() {
        ...
        const cloneHandler = (e) => {
            let container = $(e.target).closest('.fk-detail-wrap').find('.fk-detail-container')[0];
        ...
        $(document).on('click', ".quantity-field .add", (event) => inputRangeHandler(event, 'add'));
        $(document).on('click', ".quantity-field .sub", (event) => inputRangeHandler(event, 'sub'));
        ...
        function inputRangeHandler(event, identifier) {
            ...
            let input_val = $(inputField).val() !== "" ? parseInt($(inputField).val()) : 0;
        ...
        $(".transport").on("click", function() {
            if($(this).find("input").is(":checked")) {
                $(this).closest(".fk-booking-detail").find(".fk-booking-field .address").fadeIn();
            } else {
                $(this).closest(".fk-booking-detail").find(".fk-booking-field .address").fadeOut();
            }
        })
        $(".dimension_wrap .dimension-check").on("click", function() {
            if($(this).find("input").is(":checked")) {
                let dimension = $(this).find("input").val();
                let dimension_fields = [...$(this).closest(".fk-containerType").find(".fk-product-detail .fk-clone .fk-product-scale")];
